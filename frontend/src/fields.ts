...
export const groups: {key: string; title: string; fields: Field[]}[] = [
 {key:'assignment', title:'Assignment & people', fields:[
  f('reference','Report reference'),f('bank_reference','Bank reference'),f('purpose','Valuation purpose'),
 ...
 {key:'property', title:'Property & location', fields:[
  ...
  f('north','North boundary'),f('east','East boundary'),f('south','South boundary'),f('west','West boundary'),f('services','Services and infrastructure','textarea')]},
 {key:'building', title:'Building', fields:[
  f('description','Building description','textarea'),f('area_source','Source of floor areas'),f('roof','Roof'),f('walls','Walls'),f('floor_finish','Floor finish'),f('doors_windows','Doors and windows','textarea'),f('conveniences','Conveniences','textarea'),f('condition','Condition'),f('occupier','Occupier')]},
 ...
 {key:'valuer',title:'Valuer details',fields:[f('name','Valuer name'),f('qualifications','Qualifications','textarea'),f('registration','Professional registration'),f('address','Address','textarea'),f('phone','Telephone'),f('email','Email')]}
];
